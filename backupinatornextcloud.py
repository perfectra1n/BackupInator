...
class BackupinatorNextcloud(BaseBackupClass):
    def __init__(self, debug=False) -> None:
        ...
        self.nextcloud_session.auth = {
            "username": self.nextcloud_values["username"],
            "password": self.nextcloud_values["password"],
        }
    ...
    def list_files(self, directory):
        ...
        """
        url = f"{self.nextcloud_url}/remote.php/dav/files/{self.nextcloud_session.auth['username']}/{directory}"
    ...
    def upload_file(self, local_path, remote_backup_path):
        ...
        """
        url = f"{self.nextcloud_url}/remote.php/dav/files/{self.nextcloud_session.auth['username']}/{remote_backup_path}"
    ...
    def create_folder(self, folder_path):
        ...
        """
        url = f"{self.nextcloud_url}/remote.php/dav/files/{self.nextcloud_session.auth['username']}/{folder_path}"
    ...
    def delete_file_or_folder(self, path):
        ...
        """
        url = f"{self.nextcloud_url}/remote.php/dav/files/{self.nextcloud_session.auth['username']}/{path}"
